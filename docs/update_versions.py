...
parser = argparse.ArgumentParser(
    description="Get current versions.js file from the gitlab pages URL and extend the "
...
parser.add_argument(
    ...
    type=str,
    help="Path where the current and updated versions.js file should be stored.",
    required=True,
)
parser.add_argument(
    "--folder",
    metavar="folder",
    type=str,
    help="Folder name where the version is stored",
    required=True,
)
parser.add_argument(
    "--version",
...
versions.append({"version": args.version, "folder": args.folder, "has_pdf": False})
