...
#ifndef CHIPCARDPROFILEDOORDATAMODEL_H
#define CHIPCARDPROFILEDOORDATAMODEL_H
...
class ChipCardProfileDoorDataModel : public CommonDataModel, public IDataModel
{
  Q_OBJECT

public:
    ChipCardProfileDoorDataModel(QObject* parent = 0);
    ...
    // Getter
    int ChipCardProfileDoorIdIndex() const { return m_ChipCardProfileDoorIdIndex; }
...
private:
  ...
  const QString m_tableName = QLatin1String("chip_card_profile_door");
    int m_ChipCardProfileDoorIdIndex;
    int m_ChipCardProfileIdIndex;
    int m_ChipCardDoorsIdIndex;
    int m_LastUpdateIndex;


};

#endif // CHIPCARDPROFILEDOORDATAMODEL_H
