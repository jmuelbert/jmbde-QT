/*
   ...
   //
*/
#ifndef COMPUTERSOFTWAREDATAMODEL_H
#define COMPUTERSOFTWAREDATAMODEL_H
...
class ComputerSoftwareDataModel : public CommonDataModel, public IDataModel
{
  Q_OBJECT

public:
    ComputerSoftwareDataModel(QObject* parent = 0);
