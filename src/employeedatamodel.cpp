...
void EmployeeDataModel::addDataSet() {
  ...
  QSqlQuery query;
  query.prepare(
      QLatin1String("INSERT INTO EMPLOYEE ("
  ...
  query.bindValue(QLatin1String(":employee_nr"),
                  Database::Table::DEFAULT_FOREIGN_VALUE);
  query.bindValue(QLatin1String(":title_id"),
                  Database::Table::DEFAULT_FOREIGN_VALUE);
  query.bindValue(QLatin1String(":firstname"), QLatin1String("Test"));
  query.bindValue(QLatin1String(":lastname"), QLatin1String("Test"));
  query.bindValue(QLatin1String(":address_id"),
                  Database::Table::DEFAULT_FOREIGN_VALUE);
  ...
  query.bindValue(QLatin1String(":department_id"),
                  Database::Table::DEFAULT_FOREIGN_VALUE);
  query.bindValue(QLatin1String(":function_id"),
                  Database::Table::DEFAULT_FOREIGN_VALUE);
  query.bindValue(QLatin1String(":computer_id"),
                  Database::Table::DEFAULT_FOREIGN_VALUE);
  query.bindValue(QLatin1String(":printer_id"),
                  Database::Table::DEFAULT_FOREIGN_VALUE);
  query.bindValue(QLatin1String(":phone_id"),
                  Database::Table::DEFAULT_FOREIGN_VALUE);
  query.bindValue(QLatin1String(":mobile_id"),
                  Database::Table::DEFAULT_FOREIGN_VALUE);
  query.bindValue(QLatin1String(":fax_id"),
                  Database::Table::DEFAULT_FOREIGN_VALUE);
  query.bindValue(QLatin1String(":employee_account_id"),
                  Database::Table::DEFAULT_FOREIGN_VALUE);
  query.bindValue(QLatin1String(":employee_document_id"),
                  Database::Table::DEFAULT_FOREIGN_VALUE);
  query.bindValue(QLatin1String(":chipcard_id"),
                  Database::Table::DEFAULT_FOREIGN_VALUE);
