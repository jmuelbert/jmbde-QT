...
ComputerDataModel::ComputerDataModel(QObject *parent)
...
ComputerDataModel::~ComputerDataModel() = default;
...
QString ComputerDataModel::generateFormularString(QAbstractTableModel *model,
                                                  QString header) {
    QString outString;
    int columnCount = model->columnCount();
    int rowCount = model->rowCount();
