...
#ifndef CHIPCARDDATAMODEL_H
#define CHIPCARDDATAMODEL_H
...
class ChipCardDataModel : public CommonDataModel, public IDataModel
{
  Q_OBJECT
public:
    ChipCardDataModel(QObject* parent = 0);
