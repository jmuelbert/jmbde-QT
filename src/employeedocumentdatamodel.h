...
#ifndef EMPLOYEEDOCUMENTDATAMODEL_H
#define EMPLOYEEDOCUMENTDATAMODEL_H
...
class EmployeeDocumentDataModel: public CommonDataModel, public IDataModel
{
  Q_OBJECT

public:
    EmployeeDocumentDataModel(QObject* parent = 0);
