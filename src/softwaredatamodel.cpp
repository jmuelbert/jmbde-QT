/*
   // SoftwareDataModel softwaredatamodel.cpp
   // part of <Project>
   //
...
SoftwareDataModel::SoftwareDataModel(QObject* parent) : CommonDataModel (parent)
{
...
QSqlRelationalTableModel* SoftwareDataModel::initializeRelationalModel() {
...
QSqlRelationalTableModel* SoftwareDataModel::initializeInputDataModel() {
...
QSqlTableModel* SoftwareDataModel::initializeViewModel() {
...
QString SoftwareDataModel::generateTableString(QAbstractTableModel* model, QString header) {
  QString outString;
...
QString SoftwareDataModel::generateFormularString(QAbstractTableModel* model, QString header) {
  QString outString;
  int columnCount = model->columnCount();
  int rowCount = model->rowCount();
