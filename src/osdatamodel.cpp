...
OSDataModel::OSDataModel(QObject* parent) : CommonDataModel (parent) {
...
QSqlRelationalTableModel* OSDataModel::initializeRelationalModel() {
...
QSqlRelationalTableModel* OSDataModel::initializeInputDataModel() {
...
QSqlTableModel* OSDataModel::initializeViewModel() {
...
QString OSDataModel::generateTableString(QAbstractTableModel* model, QString header) {
  QString outString;
...
QString OSDataModel::generateFormularString(QAbstractTableModel* model, QString header) {
  QString outString;
  int columnCount = model->columnCount();
  int rowCount = model->rowCount();
