...
#ifndef CHIPCARDDOORSDATAMODEL_H
#define CHIPCARDDOORSDATAMODEL_H
...
class ChipCardDoorsDataModel : public CommonDataModel, public IDataModel
{
  Q_OBJECT

public:
    ChipCardDoorsDataModel(QObject* parent = 0);
...
#endif // CHIPCARDDOORSDATAMODEL_H
