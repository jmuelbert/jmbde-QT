...
ChipCardProfileDoorDataModel::ChipCardProfileDoorDataModel(QObject* parent) : CommonDataModel (parent)
{
    // Set the Model
...
QSqlRelationalTableModel* ChipCardProfileDoorDataModel::initializeRelationalModel() {
...
QSqlRelationalTableModel* ChipCardProfileDoorDataModel::initializeInputDataModel() {
...
QSqlTableModel* ChipCardProfileDoorDataModel::initializeViewModel() {
...
QString ChipCardProfileDoorDataModel::generateTableString(QAbstractTableModel* model, QString header) {
  QString outString;
...
QString ChipCardProfileDoorDataModel::generateFormularString(QAbstractTableModel* model, QString header) {
  QString outString;
  int columnCount = model->columnCount();
  int rowCount = model->rowCount();
