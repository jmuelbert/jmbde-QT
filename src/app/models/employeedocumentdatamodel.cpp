...
EmployeeDocumentDataModel::EmployeeDocumentDataModel(QObject *parent)
...
EmployeeDocumentDataModel::initializeRelationalModel() {
...
QSqlRelationalTableModel *
EmployeeDocumentDataModel::initializeInputDataModel() {
...
QString
EmployeeDocumentDataModel::generateTableString(QAbstractTableModel *model,
                                               QString header) {
  QString outString;
...
QString
EmployeeDocumentDataModel::generateFormularString(QAbstractTableModel *model,
                                                  QString header) {
  QString outString;
  int columnCount = model->columnCount();
  int rowCount = model->rowCount();
