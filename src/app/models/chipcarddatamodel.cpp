...
ChipCardDataModel::ChipCardDataModel(QObject* parent) : CommonDataModel(parent)
{
    // Set the Model
...
ChipCardDataModel::~ChipCardDataModel()
    = default;

bool ChipCardDataModel::createDataTable()
{
...
void ChipCardDataModel::setIndexes()
{
...
QSqlRelationalTableModel* ChipCardDataModel::initializeRelationalModel()
{
...
QSqlRelationalTableModel* ChipCardDataModel::initializeInputDataModel()
{
...
QSqlTableModel* ChipCardDataModel::initializeViewModel()
{
...
QString ChipCardDataModel::generateTableString(QAbstractTableModel* model, QString header)
{
    QString outString;
...
QString ChipCardDataModel::generateFormularString(QAbstractTableModel* model, QString header)
{
    QString outString;
    int columnCount = model->columnCount();
    int rowCount = model->rowCount();
