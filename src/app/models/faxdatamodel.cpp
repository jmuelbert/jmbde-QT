...
FaxDataModel::FaxDataModel(QObject* parent) : CommonDataModel(parent)
{
    // Set the Model
...
QSqlRelationalTableModel* FaxDataModel::initializeInputDataModel()
{
...
QSqlTableModel* FaxDataModel::initializeViewModel()
{
...
QString FaxDataModel::generateTableString(QAbstractTableModel* model, QString header)
{
    QString outString;
...
QString FaxDataModel::generateFormularString(QAbstractTableModel* model, QString header)
{
    QString outString;
    int columnCount = model->columnCount();
    int rowCount = model->rowCount();
