...
ChipCardProfileDataModel::ChipCardProfileDataModel(QObject* parent) : CommonDataModel(parent)
{
    // Set the Model
...
QSqlRelationalTableModel* ChipCardProfileDataModel::initializeRelationalModel()
{
...
QSqlRelationalTableModel* ChipCardProfileDataModel::initializeInputDataModel()
{
...
QSqlTableModel* ChipCardProfileDataModel::initializeViewModel()
{
...
QString ChipCardProfileDataModel::generateTableString(QAbstractTableModel* model, QString header)
{
    QString outString;
...
QString ChipCardProfileDataModel::generateFormularString(QAbstractTableModel* model, QString header)
{
    QString outString;
    int columnCount = model->columnCount();
    int rowCount = model->rowCount();
