...
ChipCardProfileDoorDataModel::ChipCardProfileDoorDataModel(QObject *parent)
...
ChipCardProfileDoorDataModel::~ChipCardProfileDoorDataModel() = default;
...
void ChipCardProfileDoorDataModel::setIndexes() {
  ...
  m_ChipCardDoorsIdIndex =
      m_model->fieldIndex(QLatin1String("chip_card_doors_id"));
  m_LastUpdateIndex = m_model->fieldIndex(QLatin1String("last_update"));
}

QSqlRelationalTableModel *
ChipCardProfileDoorDataModel::initializeRelationalModel() {
...
QSqlRelationalTableModel *
ChipCardProfileDoorDataModel::initializeInputDataModel() {
...
QString
ChipCardProfileDoorDataModel::generateTableString(QAbstractTableModel *model,
                                                  QString header) {
  QString outString;
...
QString
ChipCardProfileDoorDataModel::generateFormularString(QAbstractTableModel *model,
                                                     QString header) {
  QString outString;
  int columnCount = model->columnCount();
  int rowCount = model->rowCount();
