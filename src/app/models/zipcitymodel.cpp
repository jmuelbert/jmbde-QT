...
ZipCityModel::ZipCityModel(QObject* parent) : CommonDataModel(parent)
{
...
QSqlRelationalTableModel* ZipCityModel::initializeRelationalModel()
{
...
QSqlRelationalTableModel* ZipCityModel::initializeInputDataModel()
{
...
QSqlTableModel* ZipCityModel::initializeViewModel()
{
...
QString ZipCityModel::generateTableString(QAbstractTableModel* model, QString header)
{
    QString outString;
...
QString ZipCityModel::generateFormularString(QAbstractTableModel* model, QString header)
{
    QString outString;
    int columnCount = model->columnCount();
    int rowCount = model->rowCount();
