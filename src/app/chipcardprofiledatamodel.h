...
#ifndef CHIPCARDPROFILEDATAMODEL_H
#define CHIPCARDPROFILEDATAMODEL_H
...
class ChipCardProfileDataModel : public CommonDataModel, public IDataModel
{
  Q_OBJECT

public:
    ChipCardProfileDataModel(QObject* parent = 0);
...
#endif // CHIPCARDPROFILEDATAMODEL_H
