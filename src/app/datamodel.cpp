...
QSqlError DataModel::initDb()
{
  ...
  query.prepare(QLatin1String("INSERT INTO database_version (database_version_id, version, revision, patch, last_update)  "
                "VALUES (:database_version_id, :version, :revision, :patch, :last_update)"));
  query.bindValue(QLatin1String(":database_version_id"), 1);
  query.bindValue(QLatin1String(":version"), QLatin1String(Database::Version::Version));
  query.bindValue(QLatin1String(":revision"), QLatin1String(Database::Version::Revision));
  query.bindValue(QLatin1String(":patch"), QLatin1String(Database::Version::Patch));
