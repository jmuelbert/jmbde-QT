...
void MainWindow::on_actionNew_triggered() {
  int ret = QMessageBox::warning(
      this, QLatin1String(Constants::APPL_NAME),
  ...
  if (ret == QMessageBox::Yes) {
    dm->CreateConnection();
    QMessageBox::information(this, QLatin1String(Constants::APPL_NAME),
...
void MainWindow::Not_Available_Message() {
  ...
  QMessageBox::critical(this, QLatin1String(Constants::APPL_NAME), message,
                        QMessageBox::Cancel);
}
