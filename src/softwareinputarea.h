/*
   // SoftwareInputArea softwareinputarea.h
   // part of <Project>
   //
 ...
 */
class SoftwareInputArea : public QScrollArea
{
  Q_OBJECT
  ...
  public:
     ...
     * @param index
     */
    explicit SoftwareInputArea(QWidget* parent = 0, const QModelIndex index = QModelIndex());
