...
Q_LOGGING_CATEGORY(jmbdeModelsChipCardLog, "jmuelbert.jmbde.models.chipcard", QtWarningMsg)
...
auto Model::ChipCard::generateTableString(const QString &header) -> QString
{
    ...
    qCDebug(jmbdeModelsChipCardLog) << "Header:" << header << "( Columns: " << this->m_model->columnCount() << " Rows: " << m_model->rowCount() << " )";
