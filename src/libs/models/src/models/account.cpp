...
auto Model::Account::generateTableString(QAbstractTableModel *model, const QString &header) -> QString
{
    QString outString;
...
auto Model::Account::generateFormularString(QAbstractTableModel *model, const QString &header) -> QString
{
    QString outString;
