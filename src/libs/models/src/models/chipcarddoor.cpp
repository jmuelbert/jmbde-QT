...
auto Model::ChipCardDoor::generateTableString(QAbstractTableModel *model, QString header) -> QString
{
    QString outString;
...
auto Model::ChipCardDoor::generateFormularString(QAbstractTableModel *model, QString header) -> QString
{
    QString outString;
