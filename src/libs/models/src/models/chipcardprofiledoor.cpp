...
Model::ChipCardProfileDoor::ChipCardProfileDoor()
    : CommonData()
    , m_ChipcardProfileDoorLog(QLoggingCategory("jmbde.models.chipcardprofiledoor"))
{
...
auto Model::ChipCardProfileDoor::generateTableString(const QString &header) -> QString
{
    ...
    qCDebug(m_ChipcardProfileDoorLog) << "Header:" << header << "( Columns: " << m_model->columnCount() << " Rows: " << m_model->rowCount() << " )";
