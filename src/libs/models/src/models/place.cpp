...
auto Model::Place::generateTableString(QAbstractTableModel *model, QString header) -> QString
{
    QString outString;
...
auto Model::Place::generateFormularString(QAbstractTableModel *model, QString header) -> QString
{
    QString outString;
