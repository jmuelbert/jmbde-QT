...
Model::Phone::Phone(QObject *parent)
    : CommonData(parent)
{
    // Set the Model
...
auto Model::Phone::generateTableString(QAbstractTableModel *model, QString header) -> QString
{
    QString outString;
...
auto Model::Phone::generateFormularString(QAbstractTableModel *model, QString header) -> QString
{
    QString outString;
