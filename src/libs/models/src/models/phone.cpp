...
Q_LOGGING_CATEGORY(jmbdeModelsPhoneLog, "jmuelbert.jmbde.models.phone", QtWarningMsg)
...
auto Model::Phone::generateTableString(const QString &header) -> QString
{
    ...
    qCDebug(jmbdeModelsPhoneLog) << "Header:" << header << "( Columns: " << m_model->columnCount() << " Rows: " << m_model->rowCount() << " )";
