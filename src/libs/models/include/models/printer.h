...
public:
  ...
  */
  ...
  /*!
      ...
      Returns the value of the index
   */
  JMBDEMODELS_EXPORT int NetworkNameIndex() const { return m_NetworkNameIndex; }
  ...
  /*!
      ...
      Returns the value of the index
   */
  JMBDEMODELS_EXPORT int ResourcesIndex() const { return m_ResourcesIndex; }
  ...
  /*!
      ...
      Returns the value of the index
   */
  JMBDEMODELS_EXPORT int ColorIndex() const { return m_ColorIndex; }
