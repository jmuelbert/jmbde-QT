...
public:
  ...
  */
   ...
   */
  JMBDEMODELS_EXPORT int CompanyIdIndex() const { return m_CompanyIdIndex; }
  ...
  /*!
      ...
      Returns the value of the index
   */
  JMBDEMODELS_EXPORT int Name2Index() const { return m_Name2Index; }
  ...
  /*!
      ...
      Returns the value of the index
   */
  JMBDEMODELS_EXPORT int StreetIndex() const { return m_StreetIndex; }
  ...
  /*!
      ...
      Returns the value of the index
  */
  JMBDEMODELS_EXPORT int CityIndex() const { return m_CityIndex; }
  ...
  /*!
      ...
      Returns the value of the index
  */
  JMBDEMODELS_EXPORT int ZipCodeIndex() const { return m_ZipCodeIndex; }
  ...
  /*!
      ...
      Returns the value of the index
  */
  JMBDEMODELS_EXPORT int PhoneNumberIndex() const { return m_PhoneNumberIndex; }
  ...
  /*!
      ...
      Returns the value of the index
  */
  JMBDEMODELS_EXPORT int FaxNumberIndex() const { return m_FaxNumberIndex; }
  ...
  */
  ...
  /*!
      ...
      Returns the value of the index
  */
  JMBDEMODELS_EXPORT int MailAddressIndex() const { return m_MailAddressIndex; }
