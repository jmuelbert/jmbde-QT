...
public:
  ...
  /*!
     ...
     Returns the value of the index
  */
  JMBDEMODELS_EXPORT int ServiceTagIndex() const { return m_ServiceTagIndex; }
  ...
  */
  ...
  /*!
      ...
      Returns the value of the index
   */
  JMBDEMODELS_EXPORT int MemoryIndex() const { return m_MemoryIndex; }
  ...
  /*!
     ...
     Returns the value of the index
  */
  JMBDEMODELS_EXPORT int DriveSizeIndex() const { return m_DriveSizeIndex; }
  ...
  /*!
      ...
      Returns the value of the index
   */
  JMBDEMODELS_EXPORT int DriveTypeIndex() const { return m_DriveTypeIndex; }
  ...
  /*!
      ...
      Returns the value of the index
   */
  JMBDEMODELS_EXPORT int NetworkIndex() const { return m_NetworkIndex; }
