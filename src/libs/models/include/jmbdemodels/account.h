...
public:
  ...
  */
   ...
   */
  JMBDEMODELS_EXPORT auto getAccountIdIndex() const -> int { return m_AccountIdIndex; }
  ...
  /*!
      ...
      \return the value of the index
   */
  JMBDEMODELS_EXPORT auto getUserNameIndex() const -> int { return m_UserNameIndex; }
  ...
  /*!
      ...
      \return the value of the index
   */
  JMBDEMODELS_EXPORT auto getPasswordIndex() const -> int { return m_PasswordIndex; }
  ...
  /*!
      ...
      \return the value of the index
   */
  JMBDEMODELS_EXPORT auto getSystemDataIndex() const -> int { return m_SystemDataIdIndex; }
