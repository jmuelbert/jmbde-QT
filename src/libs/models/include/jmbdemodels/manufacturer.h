...
public:
  ...
  */
  ...
  /*!
      ...
      Returns the value of the index
   */
  JMBDEMODELS_EXPORT int getMailAddressIndex() const { return m_MailAddressIndex; }
  ...
  /*!
      ...
      Returns the value of the index
   */
  JMBDEMODELS_EXPORT int getPhoneNumberIndex() const { return m_PhoneNumberIndex; }
  ...
  /*!
      ...
      Returns the value of the index
   */
  JMBDEMODELS_EXPORT int getHotlineNumberIndex() const { return m_HotlineNumberIndex; }
