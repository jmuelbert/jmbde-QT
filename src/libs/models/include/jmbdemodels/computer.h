...
public:
  ...
  */
  ...
  /*!
     ...
     Returns the value of the index
  */
  JMBDEMODELS_EXPORT int getServiceTagIndex() const { return m_ServiceTagIndex; }
  ...
  /*!
     ...
     Returns the value of the index
  */
  JMBDEMODELS_EXPORT int getServiceNumberIndex() const { return m_ServiceNumberIndex; }
 ...
 */
  ...
  /*!
      ...
      Returns the value of the index
   */
  JMBDEMODELS_EXPORT int getManufacturerIdIndex() const { return m_ManufacturerIdIndex; }
  ...
  */
  ...
  /*!
      ...
      Returns the value of the index
   */
  JMBDEMODELS_EXPORT int getProcessorIdIndex() const { return m_ProcessorIdIndex; }
  ...
  /*!
     ...
     database
      ...
      Returns the value of the index
   */
  JMBDEMODELS_EXPORT int getComputerSoftwareIdIndex() const { return m_ComputerSoftwareIdIndex; }
