...
Q_DECLARE_LOGGING_CATEGORY(jmbdeWidgetsPlaceInputAreaLog)

namespace Ui
{
class PlaceInputArea;
}

/**
 * @brief The PlaceInputArea class
 */
class JMBDEWIDGETS_EXPORT PlaceInputArea : public QGroupBox
{
    Q_OBJECT

public:
    /**
       @brief PlaceInputArea
       @param parent The pointer to the parent object
       @param index The index for view the data
     */
    explicit PlaceInputArea(QWidget *parent = nullptr, const QModelIndex &index = QModelIndex());
