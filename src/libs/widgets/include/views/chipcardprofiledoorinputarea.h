...
namespace Ui
{
class ChipCardProfileDoorInputArea;
}

/**
 * @brief The ChipCardProfileDoorInputArea class
 */
class JMBDEWIDGETS_EXPORT ChipCardProfileDoorInputArea : public QGroupBox
{
    Q_OBJECT

public:
    /**
       @brief ChipCardProfileDoorInputAreaa
       @param parent The pointer to the parent object
       @param index The index for view the data
     */
    explicit ChipCardProfileDoorInputArea(QWidget *parent = nullptr, const QModelIndex &index = QModelIndex());

    /**
     * @brief ~ChipCardProfileDoorInputArea();
     */
...
private:
     ...
     * @brief ui
     */
    Ui::ChipCardProfileDoorInputArea *ui;
     ...
     * @brief m_dataContext
     */
    Model::ChipCardProfileDoor *m_chipCardProfileDoorModel = {};
