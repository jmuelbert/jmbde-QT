...
namespace Ui
{
class ZipCityInputArea;
}

/**
 * @brief The ZipCityInputArea class
 */
class JMBDEWIDGETS_EXPORT ZipCityInputArea : public QGroupBox
{
    Q_OBJECT

public:
    /**
       @brief ZipCityInputArea
       @param parent The pointer to the parent object
       @param index The index for view the data
     */
    explicit ZipCityInputArea(QWidget *parent = nullptr, const QModelIndex &index = QModelIndex());
