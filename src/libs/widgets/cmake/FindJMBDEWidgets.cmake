...
find_path(JMBDEWidgets_INCLUDE_DIR
    NAMES datacontext.h
...
find_package_handle_standard_args(JMBDEWidgets
...
if(JMBDEWidgets_FOUND AND NOT TARGET JMBDEWidgetsJSON::JMBDEWidgets)
    ...
    set_target_properties(JMBDEWidgets::JMBDEWidgets PROPERTIES
        INTERFACE_INCLUDE_DIRECTORIES "${JMBDEWidgets_INCLUDE_DIRS}"
    )
endif()
