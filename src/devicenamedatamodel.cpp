...
DeviceNameDataModel::DeviceNameDataModel(QObject* parent) : CommonDataModel (parent)
{
    // Set the Model
...
QString DeviceNameDataModel::generateTableString(QAbstractTableModel* model, QString header) {
  QString outString;
...
QString DeviceNameDataModel::generateFormularString(QAbstractTableModel* model, QString header) {
  QString outString;
  int columnCount = model->columnCount();
  int rowCount = model->rowCount();
