...
QSqlRelationalTableModel *Model::Company::initializeRelationalModel() {
...
QSqlRelationalTableModel *Model::Company::initializeInputDataModel() {
...
QSqlTableModel *Model::Company::initializeViewModel() {
...
QString Model::Company::generateTableString(QAbstractTableModel *model,
                                            QString header) {
    QString outString;

#if QT_VERSION >= QT_VERSION_CHECK(5, 12, 2)
    qCDebug(companyLC, "Header: %s ( Columns: %i - Rows: %i )",
...
QString Model::Company::generateFormularString(QAbstractTableModel *model,
                                               QString header) {
    QString outString;
