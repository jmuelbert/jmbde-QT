...
QSqlRelationalTableModel *Model::Computer::initializeRelationalModel() {
...
QSqlRelationalTableModel *Model::Computer::initializeInputDataModel() {
...
QSqlTableModel *Model::Computer::initializeViewModel() {
...
QString Model::Computer::generateTableString(QAbstractTableModel *model,
                                             QString header) {
    QString outString;

#if QT_VERSION >= QT_VERSION_CHECK(5, 12, 2)
    qCDebug(computerLC, "Header: %s ( Columns: %i - Rows: %i )",
...
QString Model::Computer::generateFormularString(QAbstractTableModel *model,
                                                QString header) {
    QString outString;
