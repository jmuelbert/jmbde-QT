...
QSqlRelationalTableModel *Model::ComputerSoftware::initializeRelationalModel() {
...
QSqlRelationalTableModel *Model::ComputerSoftware::initializeInputDataModel() {
...
QSqlTableModel *Model::ComputerSoftware::initializeViewModel() {
...
QString Model::ComputerSoftware::generateTableString(QAbstractTableModel *model,
                                                     QString header) {
    QString outString;

#if QT_VERSION >= QT_VERSION_CHECK(5, 12, 2)
    qCDebug(computerSoftwareLC, "Header: %s ( Columns: %i - Rows: %i )",
...
QString
Model::ComputerSoftware::generateFormularString(QAbstractTableModel *model,
                                                QString header) {
    QString outString;
