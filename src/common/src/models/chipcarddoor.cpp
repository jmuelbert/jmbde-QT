...
Model::ChipCardDoor::ChipCardDoor(QObject *parent) : CommonData(parent) {
    // Set the Model
...
QSqlRelationalTableModel *Model::ChipCardDoor::initializeRelationalModel() {
...
QSqlRelationalTableModel *Model::ChipCardDoor::initializeInputDataModel() {
...
QSqlTableModel *Model::ChipCardDoor::initializeViewModel() {
...
QString Model::ChipCardDoor::generateTableString(QAbstractTableModel *model,
                                                 QString header) {
    QString outString;

#if QT_VERSION >= QT_VERSION_CHECK(5, 12, 2)
    qCDebug(chipCardDoorLC, "Header: %s ( Columns: %i - Rows: %i )",
...
QString Model::ChipCardDoor::generateFormularString(QAbstractTableModel *model,
                                                    QString header) {
    QString outString;
