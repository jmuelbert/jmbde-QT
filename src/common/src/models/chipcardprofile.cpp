...
Model::ChipCardProfile::ChipCardProfile(QObject *parent) : CommonData(parent) {
    // Set the Model
...
QSqlRelationalTableModel *Model::ChipCardProfile::initializeRelationalModel() {
...
QSqlRelationalTableModel *Model::ChipCardProfile::initializeInputDataModel() {
...
QSqlTableModel *Model::ChipCardProfile::initializeViewModel() {
...
QString Model::ChipCardProfile::generateTableString(QAbstractTableModel *model,
                                                    QString header) {
    QString outString;

#if QT_VERSION >= QT_VERSION_CHECK(5, 12, 2)
    qCDebug(chipCardProfileLC, "Header: %s ( Columns: %i - Rows: %i )",
...
QString
Model::ChipCardProfile::generateFormularString(QAbstractTableModel *model,
                                               QString header) {
    QString outString;
