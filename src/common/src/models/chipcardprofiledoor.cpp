...
Model::ChipCardProfileDoor::ChipCardProfileDoor(QObject *parent)
    : CommonData(parent) {
    // Set the Model
...
Model::ChipCardProfileDoor::initializeRelationalModel() {
...
QSqlRelationalTableModel *
Model::ChipCardProfileDoor::initializeInputDataModel() {
...
QSqlTableModel *Model::ChipCardProfileDoor::initializeViewModel() {
...
QString
Model::ChipCardProfileDoor::generateTableString(QAbstractTableModel *model,
                                                QString header) {
    QString outString;

#if QT_VERSION >= QT_VERSION_CHECK(5, 12, 2)
    qCDebug(chipCardProfileDoorLC, "Header: %s ( Columns: %i - Rows: %i )",
...
QString
Model::ChipCardProfileDoor::generateFormularString(QAbstractTableModel *model,
                                                   QString header) {
    QString outString;
