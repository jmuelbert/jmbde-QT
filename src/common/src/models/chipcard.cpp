...
Model::ChipCard::ChipCard(QObject *parent) : CommonData(parent) {
    // Set the Model
...
QSqlRelationalTableModel *Model::ChipCard::initializeRelationalModel() {
...
QSqlRelationalTableModel *Model::ChipCard::initializeInputDataModel() {
...
QSqlTableModel *Model::ChipCard::initializeViewModel() {
...
QString Model::ChipCard::generateTableString(QAbstractTableModel *model,
                                             QString header) {
    QString outString;

#if QT_VERSION >= QT_VERSION_CHECK(5, 12, 2)
    qCDebug(chipCardLC, "Header: %s ( Columns: %i - Rows: %i )",
...
QString Model::ChipCard::generateFormularString(QAbstractTableModel *model,
                                                QString header) {
    QString outString;
