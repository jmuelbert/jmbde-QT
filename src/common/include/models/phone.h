...
#ifndef SRC_APP_MODELS_PHONEDATAMODEL_H_
#define SRC_APP_MODELS_PHONEDATAMODEL_H_
...
namespace Model {
class JMBDE_COMMON_EXPORT PhoneDataModel : public CommonData {
public:
    /**
     ...
     */
    virtual ~PhoneDataModel() = default;
