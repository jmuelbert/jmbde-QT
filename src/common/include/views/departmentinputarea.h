...
namespace Ui {
class JMBDE_COMMON_EXPORT DepartmentInputArea;
}

/**
 * @brief The DepartmentInputArea class
 */
class JMBDE_COMMON_EXPORT DepartmentInputArea : public QGroupBox {
    Q_OBJECT
...
public:
     ...
     * @param index
     */
    explicit DepartmentInputArea(QWidget *parent = nullptr,
