...
DocumentsDataModel::DocumentsDataModel(QObject* parent) : CommonDataModel(parent)
{
    // Set the Model
...
QSqlRelationalTableModel* DocumentsDataModel::initializeRelationalModel()
{
...
QSqlRelationalTableModel* DocumentsDataModel::initializeInputDataModel()
{
...
QSqlTableModel* DocumentsDataModel::initializeViewModel()
{
...
QString DocumentsDataModel::generateTableString(QAbstractTableModel* model, QString header)
{
    QString outString;
...
QString DocumentsDataModel::generateFormularString(QAbstractTableModel* model, QString header)
{
    QString outString;
    int columnCount = model->columnCount();
    int rowCount = model->rowCount();
