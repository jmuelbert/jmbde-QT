...
ChipCardProfileDataModel::ChipCardProfileDataModel(QObject *parent)
...
ChipCardProfileDataModel::~ChipCardProfileDataModel() = default;
...
ChipCardProfileDataModel::initializeRelationalModel() {
...
QString
ChipCardProfileDataModel::generateTableString(QAbstractTableModel *model,
                                              QString header) {
  QString outString;
...
QString
ChipCardProfileDataModel::generateFormularString(QAbstractTableModel *model,
                                                 QString header) {
  QString outString;
  int columnCount = model->columnCount();
  int rowCount = model->rowCount();
