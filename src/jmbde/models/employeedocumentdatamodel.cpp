...
EmployeeDocumentDataModel::EmployeeDocumentDataModel(QObject* parent) : CommonDataModel(parent)
{
    // Set the Model
...
QSqlRelationalTableModel* EmployeeDocumentDataModel::initializeRelationalModel()
{
...
QSqlRelationalTableModel* EmployeeDocumentDataModel::initializeInputDataModel()
{
...
QSqlTableModel* EmployeeDocumentDataModel::initializeViewModel()
{
...
QString EmployeeDocumentDataModel::generateTableString(QAbstractTableModel* model, QString header)
{
    QString outString;
...
QString EmployeeDocumentDataModel::generateFormularString(QAbstractTableModel* model, QString header)
{
    QString outString;
    int columnCount = model->columnCount();
    int rowCount = model->rowCount();
