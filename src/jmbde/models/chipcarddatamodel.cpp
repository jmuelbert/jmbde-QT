...
ChipCardDataModel::ChipCardDataModel(QObject *parent)
...
ChipCardDataModel::~ChipCardDataModel() = default;
...
QString ChipCardDataModel::generateFormularString(QAbstractTableModel *model,
                                                  QString header) {
  QString outString;
  int columnCount = model->columnCount();
  int rowCount = model->rowCount();
