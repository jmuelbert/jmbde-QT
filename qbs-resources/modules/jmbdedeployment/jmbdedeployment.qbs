...
Module {
    ...
    setupRunEnvironment: {
        ...
        env["PATH"] = PathTools.prependOrSetPath([
            FileInfo.joinPaths(product.qbs.installRoot, product.qbs.installPrefix, product.jmbdedeployment.binDir)
        ].join(product.qbs.pathListSeparator), env["PATH"], product.qbs.pathListSeparator);
        env["QT_PLUGIN_PATH"] = PathTools.prependOrSetPath([
            FileInfo.joinPaths(product.qbs.installRoot, product.qbs.installPrefix, product.jmbdedeployment.pluginsDir)
        ...
        env["QML2_IMPORT_PATH"] = PathTools.prependOrSetPath([
            FileInfo.joinPaths(product.qbs.installRoot, product.qbs.installPrefix, product.jmbdedeployment.qmlDir)
        ...
        if (product.qbs.hostOS.contains("unix") && product.qbs.targetOS.contains("unix")) {
            env["LD_LIBRARY_PATH"] = PathTools.prependOrSetPath([
                FileInfo.joinPaths(product.qbs.installRoot, product.qbs.installPrefix, product.jmbdedeployment.libDir)
            ...
            env["XDG_DATA_DIRS"] = PathTools.prependOrSetPath([
                FileInfo.joinPaths(product.qbs.installRoot, product.qbs.installPrefix, product.jmbdedeployment.dataDir)
            ...
            env["XDG_CONFIG_DIRS"] = PathTools.prependOrSetPath([
                FileInfo.joinPaths(product.qbs.installRoot, product.qbs.installPrefix, product.jmbdedeployment.etcDir, "xdg")
