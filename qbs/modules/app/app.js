...
function transformedExportBlock(product, input, output) {
    ...
    try {
        ...
        var modulePath = FileInfo.joinPaths("/",
            product.moduleProperty("app", "app_qbs_modules_path"), product.name);
        var includePath = FileInfo.joinPaths("/",
            product.moduleProperty("app", "app_include_path"));
        ...
        var dataPath = FileInfo.joinPaths("/", product.moduleProperty("app", "app_data_path"));
        var relPathToData = FileInfo.relativePath(modulePath, dataPath);
        exportBlock = exportBlock.replace(/app.export_data_base/g, "path + '/" +
            relPathToData + "'");
