...
QbsProduct {
    type: ["dynamiclibrary", "pluginSpec", "app.dev-module"]
    installDir: app.app_plugin_path
    ...
    targetName: AppFunctions.qtLibraryName(qbs, name)
    destinationDirectory: FileInfo.joinPaths(project.buildDirectory, app.app_plugin_path)
