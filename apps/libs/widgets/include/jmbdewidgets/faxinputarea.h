...
/**
 * @brief The FaxInputArea class
 */
class JMBDEWIDGETS_EXPORT FaxInputArea : public QGroupBox
{
  Q_OBJECT
...
public:
   ...
   */
  explicit FaxInputArea(QWidget *parent = nullptr, const QModelIndex &index = QModelIndex());
