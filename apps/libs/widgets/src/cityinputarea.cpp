...
CityInputArea::CityInputArea(QWidget *parent, const QModelIndex &index) : QGroupBox(parent), ui(new Ui::CityInputArea)
{
  ui->setupUi(this);
...
void CityInputArea::setViewOnlyMode(bool mode) { ui->cityNameLineEdit->setDisabled(mode); }
