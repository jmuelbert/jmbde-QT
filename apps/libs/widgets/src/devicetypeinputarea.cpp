...
DeviceTypeInputArea::DeviceTypeInputArea(QWidget *parent, const QModelIndex &index)
  : QGroupBox(parent), ui(new Ui::DeviceTypeInputArea)
{
  ui->setupUi(this);
...
DeviceTypeInputArea::~DeviceTypeInputArea() { delete ui; }
...
void DeviceTypeInputArea::setViewOnlyMode(bool mode) { ui->nameLineEdit->setDisabled(mode); }
