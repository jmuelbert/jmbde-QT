...
ComputerSoftwareInputArea::ComputerSoftwareInputArea(QWidget *parent, const QModelIndex &index)
  : QGroupBox(parent), ui(new Ui::ComputerSoftwareInputArea)
{
  ui->setupUi(this);
  ...
  QObject::connect(
    this->ui->editFinishPushButton, &QPushButton::released, this, &ComputerSoftwareInputArea::editFinish);
}

ComputerSoftwareInputArea::~ComputerSoftwareInputArea() { delete ui; }
