...
public:
  ...
  */
  ...
  JMBDEMODELS_EXPORT auto checkExistence(const QString &tableName, const QString &searchId, const QString &search)
    -> bool;
...
protected:
   ...
   */
  auto checkDBVersion(const QString &actualVersion,
    const QString &actualRevision /*, const QString &actualBuild */) const -> bool;
  ...
  /*!
      ...
      \return true is successful
   */
  auto update(const QString &table,
