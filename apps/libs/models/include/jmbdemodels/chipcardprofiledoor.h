...
public:
  ...
  */
   ...
   */
  JMBDEMODELS_EXPORT int getChipCardProfileDoorIdIndex() const { return m_ChipCardProfileDoorIdIndex; }
  ...
  /*!
     ...
     database
      ...
      Returns the value of the index
   */
  JMBDEMODELS_EXPORT int getChipCardProfileIdIndex() const { return m_ChipCardProfileIdIndex; }
  ...
  /*!
      ...
      Returns the value of the index
   */
  JMBDEMODELS_EXPORT int getChipCardDoorsIdIndex() const { return m_ChipCardDoorsIdIndex; }
