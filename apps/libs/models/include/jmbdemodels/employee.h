...
public:
  ...
  */
  ...
  /*!
      ...
      Returns the value of the index
   */
  JMBDEMODELS_EXPORT int getEmployeeNrIndex() const { return m_EmployeeNrIndex; }
  ...
  */
  ...
  /*!
     ...
     Returns the value of the index
  */
  JMBDEMODELS_EXPORT int getHomeMobileIndex() const { return m_HomeMobileIndex; }
  ...
  */
  ...
  /*!
      ...
      Returns the value of the index
   */
  JMBDEMODELS_EXPORT int getBusinessMailIndex() const { return m_BusinessMailIndex; }
  ...
  /*!
      ...
      Returns the value of the index
   */
  JMBDEMODELS_EXPORT int getFunctionIdIndex() const { return m_FunctionIdIndex; }
  ...
  /*!
     ...
     database
      ...
      Returns the value of the index
   */
  JMBDEMODELS_EXPORT int getEmployeeAccountIdIndex() const { return m_EmployeeAccountIdIndex; }
  ...
  /*!
     ...
     database
      ...
      Returns the value of the index
   */
  JMBDEMODELS_EXPORT int getEmployeeDocumentIdIndex() const { return m_EmployeeDocumentIdIndex; }
  ...
  /*!
      ...
      Returns the value of the index
   */
  JMBDEMODELS_EXPORT int getChipCardIdIndex() const { return m_ChipCardIdIndex; }
