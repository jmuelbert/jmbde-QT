...
public:
   ...
   */
  explicit JMBDEMODELS_EXPORT CommonData() : m_model(nullptr), m_selectionModel(nullptr) {}
  ...
  */
  ...
  JMBDEMODELS_EXPORT int rowCount(const QModelIndex & = QModelIndex()) const override { return 200; }

  JMBDEMODELS_EXPORT int columnCount(const QModelIndex & = QModelIndex()) const override { return 200; }
  ...
  JMBDEMODELS_EXPORT QHash<int, QByteArray> roleNames() const override { return { { Qt::DisplayRole, "display" } }; }
