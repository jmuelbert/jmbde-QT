# Get the Semantic Version from a string in to form of: - x1.2.3 - 1.2.3
#

# v_string_: The string where the version needs to be extracted v_major_:
# Variable name for the major version v_minor_: Variable name for the minor
# version v_patch_: Variable name for the patch version
function(semver v_string_ v_major_ v_minor_ v_patch_)
  ...
  string(REGEX REPLACE "^[^[1-9]]*([1-9]+)" "\\1;" match_version_list_
                       ${${v_major_}})
  list(GET match_version_list_ 0 ${v_major_})
