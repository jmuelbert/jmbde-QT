# This file is part of GammaRay, the Qt application inspection and manipulation
# tool.
#
# SPDX-FileCopyrightText: 2016 Klarälvdalens Datakonsult AB, a KDAB Group
# company <info@kdab.com> Author: Volker Krause <volker.krause@kdab.com>
#
...
if(TARGET Qt${QT_VERSION_MAJOR}::qmllint)
  ...
  if(QmlLint_EXECUTABLE)
    if(NOT QMLLINT_IS_WORKING)
      # Try to fix common problems on Debian-based distros -- they provide
      # /usr/bin/qmllint, which is a symlink to
      # /usr/lib/x86_64-linux-gnu/qt4/bin/qmllint (or the Qt5 version of it).
      # The actual executable is part of different package, so might not even be
      # installed => double-check whether qmllint is working by executing it
      execute_process(
      ...
      if(_qmllint_result EQUAL 0)
        set(QMLLINT_IS_WORKING
            TRUE
            CACHE BOOL
                  "Whether the found qmllint executable is actually usable"
                  FORCE)
      endif()
    endif()
