...
# git_discribe: ex v3.1.4-201-gdbc1f69 _list may became 3; .1; .4; -201; 1; 69
...
if(_count GREATER 1) # count >= 2
  string(REGEX REPLACE "v([0-9]+)\\.[0-9]+.*$" "\\1" VERSION_MAJOR
                       ${git_describe})
...
if(_count GREATER 2) # count >= 3
  string(REGEX REPLACE "v[0-9]+\\.[0-9]+[\\.-]([0-9]+).*$" "\\1" VERSION_MICRO
                       ${git_describe})
endif()

if(_count GREATER 3) # count >= 4
  string(REGEX REPLACE "v[0-9]+\\.[0-9]+[\\.-][0-9]+-([0-9]+)-.*$" "\\1"
                       VERSION_PATCH ${git_describe})
  string(REGEX REPLACE "v[0-9]+\\.[0-9]+[\\.-][0-9]+-[0-9]+-(.*)$" "\\1"
                       VERSION_HASH ${git_describe})
endif()
