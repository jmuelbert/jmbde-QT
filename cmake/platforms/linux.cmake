...
foreach(APP_LINUX_ICON_DIMENSION ${APP_LINUX_ICON_DIMENSIONS})
        install(FILES ${CMAKE_SOURCE_DIR}/assets/icons/jmbde-${APP_LINUX_ICON_DIMENSION}.png DESTINATION "${CMAKE_INSTALL_DATADIR}/icons/hicolor/${APP_LINUX_ICON_DIMENSION}x${APP_LINUX_ICON_DIMENSION}/apps" RENAME ${TARGET_NAME}.png)
