...
configure_file(${CMAKE_SOURCE_DIR}/assets/jmbde.appdata.xml.in ${CMAKE_CURRENT_BINARY_DIR}/jmbde.appdata.xml @ONLY)
...
foreach(APP_LINUX_ICON_DIMENSION ${APP_LINUX_ICON_DIMENSIONS})
  install(
    ...
    DESTINATION "${CMAKE_INSTALL_DATADIR}/icons/hicolor/${APP_LINUX_ICON_DIMENSION}x${APP_LINUX_ICON_DIMENSION}/apps"
...
if(GZIP)
  configure_file(${CMAKE_SOURCE_DIR}/assets/${TARGET_NAME}.1.in ${CMAKE_CURRENT_BINARY_DIR}/${TARGET_NAME}.1 @ONLY)
