...
# From vcpkg If CMake does not have a mapping for MinSizeRel and RelWithDebInfo
# in imported targets it will map those configuration to the first valid
# configuration in CMAKE_CONFIGURATION_TYPES or the targets
# IMPORTED_CONFIGURATIONS. In most cases this is the debug configuration which
# is wrong.
if(NOT DEFINED CMAKE_MAP_IMPORTED_CONFIG_MINSIZEREL)
  set(CMAKE_MAP_IMPORTED_CONFIG_MINSIZEREL "MinSizeRel;Release;")
  message(
    STATUS "CMAKE_MAP_IMPORTED_CONFIG_MINSIZEREL set to MinSizeRel;Release;")
endif()
if(NOT DEFINED CMAKE_MAP_IMPORTED_CONFIG_RELWITHDEBINFO)
  set(CMAKE_MAP_IMPORTED_CONFIG_RELWITHDEBINFO "RelWithDebInfo;Release;")
  message(
    STATUS
      "CMAKE_MAP_IMPORTED_CONFIG_RELWITHDEBINFO set to RelWithDebInfo;Release;")
endif()
...
if((NOT APP_PLATFORM_LIBS_NO_DEBUG_SUBDIR)
  ...
  list(APPEND CMAKE_PREFIX_PATH ${APP_PLATFORM_LIBS_PREFIX}/debug
       ${APP_PLATFORM_LIBS_PREFIX})
  link_directories(${APP_PLATFORM_LIBS_PREFIX}/debug/lib
                   ${APP_PLATFORM_LIBS_PREFIX}/lib)
  list(APPEND CMAKE_FIND_ROOT_PATH ${APP_PLATFORM_LIBS_PREFIX}/debug
       ${APP_PLATFORM_LIBS_PREFIX})
else()
  # Release build: Put Release paths before Debug paths. Debug Paths are
  # required so that CMake generates correct info in autogenerated target files.
