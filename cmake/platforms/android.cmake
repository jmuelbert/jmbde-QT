...
set(APP_PLATFORM_LIBS_PREFIX
    ${CMAKE_SOURCE_DIR}/libs/${ANDROID_LIB_ARCH}-android)

qvlog(CMAKE_ANDROID_ARCH)

if(CMAKE_BUILD_TYPE EQUAL "DEBUG")
  set(SSL_ROOT_PATH
      "${CMAKE_SOURCE_DIR}/3rdparty/android_openssl/no-asm/latest")
else()
  set(SSL_ROOT_PATH "${CMAKE_SOURCE_DIR}/3rdparty/android_openssl/latest")
endif()

list(APPEND ANDROID_EXTRA_LIBS
     "${SSL_ROOT_PATH}/${CMAKE_ANDROID_ARCH}/libcrypto_1_1.so")
list(APPEND ANDROID_EXTRA_LIBS
     "${SSL_ROOT_PATH}/${CMAKE_ANDROID_ARCH}/libssl_1_1.so")
...
configure_file(${CMAKE_SOURCE_DIR}/assets/AndroidManifest.xml.in
               ${CMAKE_SOURCE_DIR}/assets/android/AndroidManifest.xml @ONLY)
