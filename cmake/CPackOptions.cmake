...
if(CPACK_GENERATOR MATCHES "NSIS")
  ...
  # Explanations to the following commands you can find here: https://cmake.org/
  # cmake/help/latest/cpack_gen/nsis.html#cpack_gen:CPack%20NSIS%20Generator

  # ############################################################################
  # Filename
  message(DEBUG "${PROJECT_VERSION}")
  set(CPACK_PACKAGE_FILE_NAME
      "${CPACK_PACKAGE_NAME}-${PACKAGE_VERSION_STRING}-${CPACK_PACKAGE_ARCHITECTURE}-installer${PACKAGE_NIGHTLY}"
  )
  ...
  set(CPACK_NSIS_HELP_LINK
      "https://github.com/SFTtech/openage/blob/master/doc/troubleshooting.md")

  # TODO: create welcome page set(CPACK_RESOURCE_FILE_WELCOME "")

  # ############################################################################
  # Shortcuts

  # TODO: create startmenu shortcut set(CPACK_PACKAGE_EXECUTABLES "") TODO:
  # create desktop shortcut set(CPACK_CREATE_DESKTOP_LINKS "")

  # Link to launcher (exe) can go here, *.bat is not working
  # set(CPACK_NSIS_INSTALLED_ICON_NAME
  # "${CMAKE_CURRENT_BINARY_DIR}\\\\openage.bat") SET(CPACK_PACKAGE_EXECUTABLES
  # "openage.bat;openage")
...
if(CPACK_GENERATOR MATCHES "7Z")
  message(DEBUG "${PROJECT_VERSION}")
  set(CPACK_PACKAGE_FILE_NAME
      "${CPACK_PACKAGE_NAME}-${PACKAGE_VERSION_STRING}-${CPACK_PACKAGE_ARCHITECTURE}-portable${PACKAGE_NIGHTLY}"
  )
endif()
