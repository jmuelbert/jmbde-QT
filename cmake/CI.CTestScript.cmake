# It might be better than calling 'make Continuous' for CI such as travis since it will skip the update step while still doing the later
# steps It is also makes it easier to customize the test runs and show the output since we can use command-line arguments
...
# set(CTEST_MEMORYCHECK_COMMAND "valgrind") set(CTEST_MEMORYCHECK_TYPE "ThreadSanitizer")
