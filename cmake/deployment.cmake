...
if(WIN32)
    if(RUN_IN_PLACE)
        ...
        set(CPACK_GENERATOR ZIP)
            ...
            if(CMAKE_SIZEOF_VOID_P EQUAL 8)
                # x32 - Qt5
                #  set(CPACK_WIX_UPGRADE_GUID "D1FE120E-C75C-4CFC-B11B-7EE45BF3C12C")
                # x32 - Qt6
                set(CPACK_WIX_UPGRADE_GUID "477B5F99-2A01-4D4A-A0F2-7E82705D7B25")
            else()
                # X64 - Qt5
                #  set(CPACK_WIX_UPGRADE_GUID "1230CB6D-87FD-4F2D-AF67-BC41EF1E1165")
                # X64 - Qt6
...
elseif(UNIX)
  ...
  configure_file(${CMAKE_SOURCE_DIR}/cmake/modules/postinst.in ${CMAKE_CURRENT_BINARY_DIR}/postinst @ONLY)
  configure_file(${CMAKE_SOURCE_DIR}/cmake/modules/prerm.in ${CMAKE_CURRENT_BINARY_DIR}/prerm @ONLY)
