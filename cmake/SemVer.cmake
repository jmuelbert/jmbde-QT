...
if(FETCH_SEMVER)
  cpmaddpackage(NAME semver GITHUB_REPOSITORY Neargye/semver GIT_TAG v0.3.0)
else()
  ...
  add_library(${SEMVER_LIBRARY} STATIC ${SEMVER_INCLUDE_PATH}/semver.hpp)

  target_include_directories(${SEMVER_LIBRARY} INTERFACE ${SEMVER_INCLUDE_PATH})
endif()
