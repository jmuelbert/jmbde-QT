...
update_readme() {
    cd "$BASE_DIR"
    sed -ri "s|(github.com/jmuelbert/jmbde-QT/releases/download/v)$VERSION_PATTERN|\1$@|g" README.md
    # for flatpak and AppImage
    sed -ri "s|(github.com/jmuelbert/jmbde-QT/releases/download/v$VERSION_PATTERN/qTox-v)$VERSION_PATTERN|\1$@|g" README.md
}
