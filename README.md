...
| --------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Appimage  |                                                                                                                                                                                  | [![CD: appimage Qt5 package](https://github.com/jmuelbert/jmbde-QT/actions/workflows/appimage.yml/badge.svg)](https://github.com/jmuelbert/jmbde-QT/actions/workflows/appimage.yml) |
